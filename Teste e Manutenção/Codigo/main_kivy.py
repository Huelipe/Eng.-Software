...
class FinanceAppLogic(FinanceFacade, Subject):
    ...
    def exportar_dados_csv(self, nome_arquivo="extrato_financeiro.csv"):
        try:
...
class FinanceAppMobile(MDApp):
    ...
    def exportar_csv(self):
        ...
        if self.logic.exportar_dados_csv(arquivo):
            self.mostrar_alerta("Sucesso", f"Arquivo '{arquivo}' gerado com sucesso!")
        else:
            self.mostrar_alerta("Erro", "Falha ao gerar o arquivo CSV.")
