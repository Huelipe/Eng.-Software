...
# ===================================================================
# logica principal (facade + subject)
# ===================================================================
class FinanceAppLogic(FinanceFacade, Subject):
    ...
    # ---------------------------------------------------------------
    # registrar movimentacao (apenas uma funcao)
    # ---------------------------------------------------------------
    ...
    # ---------------------------------------------------------------
    # exportar para csv (nova funcao)
    # ---------------------------------------------------------------
    def exportar_dados_csv(self, nome_arquivo="meu_extrato.csv"):
        try:
            with open(nome_arquivo, mode='w', newline='', encoding='utf-8') as f:
                # usa ponto e virgula pq o excel no brasil entende melhor assim
                ...
                for t in self.transacoes_registradas:
                    writer.writerow([
                        ...
                        t.get("descricao", ""),
                        # troca ponto por virgula pra ficar no formato pt-br
    ...
    # ---------------------------------------------------------------
    # salvar e carregar movimentacoes
    # ---------------------------------------------------------------
...
class MetaScreen(MDScreen):
    def on_pre_enter(self):
        ...
        try:
            ...
            print("id texto_progresso nao encontrado no meta.kv")
...
class RelatorioScreen(MDScreen):
    ...
    # funcao chamada pelo botao na interface
    def exportar_csv(self):
        app = MDApp.get_running_app()
        sucesso = app.logic.exportar_dados_csv()
        
        if sucesso:
            app.mostrar_alerta("Sucesso", "O arquivo 'meu_extrato.csv' foi salvo na pasta do projeto!")
        else:
            app.mostrar_alerta("Erro", "Não foi possível gerar o arquivo.")
